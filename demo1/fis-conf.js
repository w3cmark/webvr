<!--param start-->
    //修改cdn的绝对路径（测试环境）
    fis.set('cdn-path','http://test.nie.163.com/test_cdn/lxf/m/gw/20160317131725');
    //修改cdn的绝对路径（正式环境）
    fis.set('cdn-path-release','http://res.lxf.netease.com/m/gw/20160317131725');
    //修改雪碧图放大缩小倍数，默认是1，iphone是0.5
    fis.set('css-scale',1);
    //修改include文件的域名
    fis.set('include-host','http://lxf.163.com')
<!--end-->
